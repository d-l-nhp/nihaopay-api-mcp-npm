...
describe("applyBoosts", () => {
  ...
  it("does not boost an endpoint that only appears as a prefix of a different sibling path", () => {
    const hits = [
      { id: "chunk-2c", score: 0.4, text: "Call POST /v1.2/transactions/query-batch instead." },
    ];
    const result = applyBoosts(hits, "how do I call /v1.2/transactions/query");
